...
#
$sqlFile = "C:\projects\source\opensource\SQLDIY\Management.GatherTableStatisticsps.sql"
$server = "WARMACHINE";
$database = "master";
$rdatabase = "SQLDIY";
...
#                    $ds.Tables[0] | Format-Table;
                    ...
                    $bulkCopy = New-Object Data.SqlClient.SqlBulkCopy($rconn.ConnectionString); 
                    $bulkCopy.DestinationTableName = $rdatabase+".dbo.TableStats";
