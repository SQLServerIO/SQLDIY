...
#
$table = "";
$sqlFile = "C:\projects\source\opensource\SQLDIY\Management.GatherStatisticsInformationps.sql"
$server = "WARMACHINE";
$database = "master";
$rdatabase = "SQLDIY";
	    ...
	    if ($cmd)
	    {
		    ...
		    if ($data)
		    {
			    ...
			    if ($ds)
			    {
                    ...
                    $bulkCopy.DestinationTableName = $rdatabase+".dbo.StatisticsInformation"
