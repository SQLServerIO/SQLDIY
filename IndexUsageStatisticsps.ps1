...
#
$table = "";
$sqlFile = "C:\projects\source\opensource\SQLDIY\Management.GatherIndexUsageStatisticsps.sql"
$server = "WARMACHINE";
$database = "master";
$rdatabase = "SQLDIY";
	    ...
	    if ($cmd)
	    {
		    ...
		    if ($data)
		    {
			    ...
			    if ($ds)
			    {
                    ...
                    $bulkCopy.DestinationTableName = $rdatabase+".dbo.IndexUsageStatistics"
